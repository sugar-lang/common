...
/*
 * Moritz: Temporarily disables this code to get rid to the ECJ dependency. Need
 * to find another location for JavaCommands where the ECJ dependency does not
 * hurt.
 */
